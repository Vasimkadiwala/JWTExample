...
public class JWKFormKeyStoreJks {
...
//		
		...
		//Private Key 
		KeyStore.PasswordProtection keyPassword = new KeyStore.PasswordProtection("abcdef".toCharArray());
	...
	public static void signedJWTGeneration(RSAKey rsaJWK) throws Exception {
		// Create RSA-signer with the private key
				...
				JWTClaimsSet claimsSet = new JWTClaimsSet.Builder()
				    //.subject("alice")
				    .issuer("http://localhost:8080/tokens/keys")
